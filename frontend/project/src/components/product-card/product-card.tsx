    ...
    <li className="catalog-item">
      <div className="catalog-item__data">
        ...
        <div className="catalog-item__data-wrapper">
          <Link to="" className="link" onClick={handleGoToProductClick}>
      ...
      <div className="catalog-item__buttons">
        <Link to="" className="button button--small button--black-border" onClick={handleGoToUpdateProductClick} aria-label="Редактировать товар">
          Редактировать
        </Link>
